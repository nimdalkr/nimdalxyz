...
const copy: Record<Locale, DialogueCopy> = {
  ko: {
    ...
    shell: {
      ...
      unknownTitle: "그건 여기 적힌 기록만으로는 내가 아는 척하면 안 되겠네요.",
      unknownBody: "그건 Nimdal한테 직접 물어보는 게 제일 빠릅니다. 카카오톡 ID: trialhero / Telegram: @nimdal / X: @0xnimdal 순서로 편한 곳에 툭 남겨 주세요. 경력, 개인 프로젝트, Korea GTM, 일하는 방식은 여기서 바로 이어서 물어봐도 되고요.",
      inChat: "대화에서 더 보기",
      themeLabel: "대화 화면 테마",
  ...
  en: {
    ...
    shell: {
      ...
      unknownTitle: "That is not in the record here, so I should not pretend otherwise.",
      unknownBody: "Best to ask Nimdal directly: KakaoTalk ID: trialhero / Telegram: @nimdal / X: @0xnimdal. I can still help with his career, personal projects, Korea GTM experience, and operating method here.",
