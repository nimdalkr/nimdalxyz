...
export const careerCases = [
  {
    ...
    copy: {
      ko: {
        ...
        result: "기존 포트폴리오 기준, 약 3개월 만에 광고비 대비 매출(ROAS)을 약 2,000%까지 끌어올렸습니다.",
  ...
  },
  {
    ...
    copy: {
      ko: {
        ...
        result: "기존 포트폴리오 기준, 계약 기간 내내 로컬 마케팅을 흔들림 없이 운영했습니다.",
  ...
  },
  {
    ...
    copy: {
      ko: {
        ...
        result: "기존 포트폴리오 기준, 마케팅 전 월 100만~200만 원이던 매출이 2024년 9월에는 월 1억 원까지 올라왔습니다.",
  ...
  },
  {
    ...
    copy: {
      ko: {
        ...
        objective: "고객사와 파트너가 여럿 얽혀 있어도 대행 업무가 새는 곳 없이 돌아가도록 운영 체계를 잡는 것이 목표였습니다.",
        role: "캠페인 운영을 이끌며 요청 정리, 업무 배분, 일정 관리, 결과물 검수, 리포팅, 개선 제안을 맡았습니다.",
        result: "기존 포트폴리오 기준, 고객 리포팅부터 파트너 관리까지 같은 방식으로 몇 번이고 돌릴 수 있는 캠페인 운영 체계를 만들었습니다.",
  ...
  },
  {
    ...
    copy: {
      ko: {
        ...
        result: "기존 포트폴리오 기준, UXLINK, SaharaAI, edgeX, Theoriq, BLESS, Dolomite, MVL의 한국 시장 커뮤니케이션을 맡아 진행했습니다.",
  ...
  },
  {
    ...
    copy: {
      ko: {
        ...
        result: "기존 포트폴리오 기준, 한국 마케팅 방향과 실행 패널(업무 관리 화면) 구조까지 완성해 넘겼습니다.",
