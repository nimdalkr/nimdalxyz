  ...
  },
  {
    ...
    copy: {
      ko: {
        ...
        result: "기존 포트폴리오 기준, 계약 기간 내내 로컬 마케팅을 안정적으로 운영했습니다.",
  ...
  },
  {
    ...
    copy: {
      ko: {
        ...
        result: "기존 포트폴리오 기준, 마케팅 전 월 100만~200만 원이던 매출이 2024년 9월에는 월 1억 원까지 늘었습니다.",
  ...
  },
  {
    ...
    copy: {
      ko: {
        ...
        objective: "고객사와 파트너가 여럿 얽힌 대행 업무를 빠짐없이 관리할 수 있도록 운영 체계를 잡는 것이 목표였습니다.",
        role: "캠페인 운영을 이끌며 요청 정리, 업무 배분, 일정 관리, 결과물 검수, 리포팅, 개선 제안을 맡았습니다.",
        result: "기존 포트폴리오 기준, 고객 리포팅부터 파트너 관리까지 같은 방식으로 반복 운영할 수 있는 캠페인 체계를 만들었습니다.",
