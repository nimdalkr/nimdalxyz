  ...
  return (
    <div className="page">
      ...
      <main id="main-content">
        {/* 1. Cover: asymmetric split, the portrait as the printed subject. */}
        ...
        {/* 3. Work: one lead feature, then a paired index. */}
        ...
        {/* 4. Practice: a single reading column with a marginal plate. */}
        ...
        {/* 5. Career: ledger rows and client marks, flooded in ink. */}
        ...
        {/* 6. Notes: an editorial list, ruled above each entry. */}
        ...
        {/* 7. Contact: an accent flood carrying ink type. */}
